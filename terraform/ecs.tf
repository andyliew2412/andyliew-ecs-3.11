...
resource "aws_ecs_task_definition" "own_task_definition" {
  family                = "andyliewecstaskdef" # Update accordingly
  ...
  #   image_url        = "255945442255.dkr.ecr.us-east-1.amazonaws.com/andyliew-test-ecr-repo:latest"
  #   container_name   = "andyliew-test-ecs"
  #   port_name        = "andyliew-test-ecs-8080-tcp"
  #   log_group_region = "us-east-1"
  #   log_group_name   = "/ecs/andyliewtesttaskdef"
...
resource "aws_ecs_cluster" "own_cluster" {
  name = "andyliew-ecs-test-cluster" # Update accordingly
}

# Creates an ecs service

resource "aws_ecs_service" "own_service" {
  name             = "andyliew-ecs-service" # Update accordingly
